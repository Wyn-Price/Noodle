...
public abstract class BaseRemovedRandomNoodle extends BaseNoodleGenerator
{
	@Override
	protected void addTunnel(long p_180702_1_, int p_180702_3_, int p_180702_4_, ChunkPrimer p_180702_5_, double p_180702_6_, double p_180702_8_, double p_180702_10_, float p_180702_12_, float p_180702_13_, float p_180702_14_, int p_180702_15_, int p_180702_16_, double p_180702_17_)
    {
        ...
        for (Object o; p_180702_15_ < p_180702_16_; ++p_180702_15_)
        {
            ...
            f = f * 0.75F;
            Vec3d top3d = top3d();
            Vec3d bottom3d = bottom3d();
            f1 = (float) (f1 + (top3d.x - top3d.y) * top3d.z * 2.0F);
            f = (float) (f + (bottom3d.x - bottom3d.y) * bottom3d.z * 4.0F);
	...
	protected abstract Vec3d top3d();
	protected abstract Vec3d bottom3d();
